...
<template>
    <div class="mb-6 font-altone font-normal max:w-[390px] ">
          ...
          <div class="max:w-[380px] w-full mt-4 grid grid-rows-4 grid-flow-col grid-cols-[repeat(auto-fill,minmax(380px,1fr))] overflow-x-auto gap-6 snap-x snap-mandatory pb-10 custom-scrollbar">
